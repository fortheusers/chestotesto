# ChestoTesto
[![GPLv3 License](https://img.shields.io/badge/license-GPLv3-blue.svg?style=flat-square)](https://opensource.org/licenses/GPL-3.0) [![discord](https://img.shields.io/discord/339118412414582786.svg?color=blueviolet&label=discord&style=flat-square)](https://discordapp.com/invite/F2PKpEj)

![logo](logo.png)

Just a little barebones app to test [Chesto](https://gitlab.com/4TU/chesto), the GUI library behind the Homebrew App Store. Targeting PC at first, but the eventual goal is to make this a test app for any Chesto platform.

(info below is copied from hbas readme, ignore pls <3)
